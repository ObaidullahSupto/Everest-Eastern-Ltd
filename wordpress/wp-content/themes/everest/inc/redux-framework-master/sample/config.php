<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'EEL Options', 'redux-framework-demo' ),
        'page_title'           => __( 'EEL Options', 'redux-framework-demo' ),
    ...
    Redux::setSection($opt_name,array(
        ...
        'fields'=>array(
         array(
            ...
            'url'=>true,
            'default'=>array(
                'url' =>get_template_directory_uri().'/assets/img/slider/EEL.jpg'
                 )
            )
        )
    ));
    ...
    Redux::setSection($opt_name,array(
        ...
        'fields'=>array(
         array(
            ...
            'type'=>'editor',
            'default'=>'© Copyright 2018||All Rights Reserved||Theme by OS',
            'args'=>array(
                'wpautop'=>false
            )
    ...
    Redux::setSection($opt_name,array(
        ...
        'fields'=>array(
         array(
            ...
            'title'=>'About Text',
            'type'=>'editor',
            'default'=>'<h1>We provide best <br /> quality service from 1990</h1>
    ...
    Redux::setSection($opt_name,array(
        ...
        'fields'=>array(
         array(
            ...
            'title'=>'Description',
            'type'=>'editor',
            'default'=>'A good company should serve society as well as its Clients. To attain this goal, a Limited Company was floated in the name and style of Everest Eastern Ltd. On March 13, 1991 also with its Registered Office at 180, East Tejturi Bazar, Tejgaon, Dhaka. The idea behind a limited company is to expand the firms technical, financial and organizational capacity.',
            'args'=>array(
                'wpautop'=>false
            )
